...
The first additive \pathcode{shared\_dt\_v3} quarter-head plan was separately frozen at SHA-256
\pathcode{aee51f621f5e66aa15b94a369b2cf61b3a79f4b28bcdc8d3f1769ee399ba398e} and rejected by
independent review.  It retained a stale eleven-boundary retirement check, disagreed with v8's
...
contained dependency inversions.  Revision v2 is in progress.  It must preserve v1/v2 identities,
add exactly the singleton \pathcode{rdiag\_kla\_shared\_dt\_v3\_750M}, and own every new
model/schema/runner/seal binding before any production operation.
...
\begin{enumerate}[leftmargin=1.8em]
  ...
  \item complete the control-plane/evidence integration around reviewed snapshot-free replay tip
        \pathcode{7b5808a177d03dd1526d1e0c2dc7a83a0f816217}, then run the replacement authenticated
