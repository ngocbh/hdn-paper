...
final artifact closure, and runner postchecks.  The candidate safety-stop and complete-liveness
slice is now the current implementation task.  No numerical or result-bearing GPU job has yet been
accepted from this worktree.
